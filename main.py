...
def product(product_id):
    ...
    products = {
        ...
        2: {
            ...
            "image": "Снимок экрана 2024-08-08 в 05.53.49.png"
        },
        3: {
            "title": "Товар 3",
            "description": "Подробное описание товара 3. Этот товар отличается своими уникальными особенностями и характеристиками.",
